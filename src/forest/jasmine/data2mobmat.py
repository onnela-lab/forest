...
def great_circle_dist(
    ...
    # (clipping required due to measurement errors, temp may be out of the domain of "arccos")
    return _clip_and_arccos(temp)


## The following functions are optimized versions of great_circle_dist.
...
##
## If it does not, then a compiled version will be generated the first time it is called
##   using the types of the arguments that were passed in.
##   (e.g., it is compiled "lazily" or "just-in-time".)
##
