...
parser.add_argument(
    ...
    type=str,
    nargs='+',
    help="IDs of participants to run sycamore on. If not specified, "
         "sycamore analyzes all IDs included in study_folder",
)
parser.add_argument(
    '--study_folder',
    default=None,
...
compute_survey_stats(
    ...
    tz_str=args.tz_str,
    users=args.beiwe_ids,
    start_date=args.time_start,
    end_date=args.time_end,
