...
You can automate and speed up downloading your data using the Mano Python package. You can find instructions to install it here: https://github.com/harvard-nrg/mano
