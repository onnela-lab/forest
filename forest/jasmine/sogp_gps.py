...
def calculate_sigma_max(C, k, sigma2):
    """Calculate sigma max.
...
def update_system_given_gamma_tol(C, Q, alpha, k, q, gamma, sigmax):
...
def update_system_otherwise(C, Q, alpha, k, q, sigmax, gamma, e_hat):
...
def pruning_bv(bv, alpha, Q, C, S, K, sigma2, d, pars):
